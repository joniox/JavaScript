...
// in a confirmation window. If the user selects OK, the program asks
// for the number and calculates and prints its square root to the HTML
// document. If the user selects Cancel, the program prints the text
...
// The function returns true if the user selects OK. If the user selects
...
const squareRootQuery = confirm('Should I calculate the square root?');

if (squareRootQuery === true) {
  ...
  if (number < 0) {
    ...
    document.querySelector('#target').innerHTML = `Square root of ${number} is ${answer}.`;
  }
} else {
